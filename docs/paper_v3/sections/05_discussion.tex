...
is built around the anchor: the calibrated utility
$\tilde{\mathcal{R}}_i^{(t)}$ (Eq.~\ref{eq:calibrated}) acts as a
...
calibrated-utility carrier or any particular scalar utility
...
no-anchor calibrated-utility base.
