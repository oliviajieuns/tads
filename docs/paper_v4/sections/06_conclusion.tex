...
(a deterministic pool-normalised composite reward
$\mathcal{R}_i^{(t)} \in (0,1)$, a single multiplicative
...
\textsc{TADS} improves over the composite-reward base on the
